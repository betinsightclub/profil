...
(() => {
  ...
  function lang() {
    ...
    return LABELS[raw] ? raw : (LABELS[raw.split("-")[0]] ? raw.split("-")[0] : "de");
  }
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .bi-theme-dot{display:inline-block;width:10px;height:10px;border-radius:50%;border:1px solid rgba(255,255,255,.32);box-shadow:0 0 0 2px rgba(255,255,255,.03)}
      ...
      .bi-language-settings-block .bi-nav-settings-title{grid-column:1/-1}
      .bi-language-settings-block .bi-language-select{width:100%!important;margin:0!important}
      ...
      html[data-bi-theme="light"] .bi-nav-brand{border-bottom-color:rgba(31,77,102,.10)}
      html[data-bi-theme="light"] .bi-nav-link,html[data-bi-theme="light"] .bi-nav-group-button,html[data-bi-theme="light"] .bi-nav-sub-link{color:#517287}
      ...
      html[data-bi-theme="light"] .bi-nav-group-current>.bi-nav-group-button{color:#15384d;background:rgba(25,126,187,.06)}
      html[data-bi-theme="light"] .bi-nav-icon{border-color:rgba(31,83,111,.10);background:rgba(255,255,255,.66);color:#66869a}
      ...
      html[data-bi-theme="light"] .bi-nav-footer{border-top-color:rgba(31,77,102,.10)}html[data-bi-theme="light"] .bi-nav-footer-caption,html[data-bi-theme="light"] .bi-nav-settings-title{color:#6f8d9d}
      html[data-bi-theme="light"] .bi-language-select{background:#eef5f8!important;color:#274d62!important}
    `;
  ...
  function createSwitcher() {
    ...
    wrap.innerHTML = `
      <button type="button" class="bi-theme-toggle" aria-expanded="false">
        ...
        <span class="bi-theme-toggle-label">${labels.title}</span>
        <span class="bi-theme-chevron" aria-hidden="true">⌄</span>
      </button>
      <div class="bi-theme-options" hidden>
        <button type="button" data-theme="blue"><span class="bi-theme-dot bi-theme-dot-blue"></span><span>${labels.blue}</span></button>
  ...
  window.BetInsightTheme=Object.freeze({applyTheme,currentTheme,createSwitcher,themes:[...THEMES]});
})();
